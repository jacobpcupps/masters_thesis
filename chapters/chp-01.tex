...
``Unapologetic'' thus presents itself as nerdcore by drawing on these methods. Both the track and the
...
Eagle's art rap draws on a similar discourse, one that suggests ``Unapologetic'' may be a new type
