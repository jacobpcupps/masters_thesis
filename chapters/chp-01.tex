...
For me as a listener, ``Unapologetic'' engenders two distinct connections to the nerdcore subgenre. First,
its beat layer is primarily constructed from two synthesizer loops. Although synthesizer does not explicitly
...
and social marginalized people begin to make hip-hop using their skill sets and experiences.''\footnote{
 ...
 By 1994, according to Adam Krims, a variety subgenres of
rap had emerged, each harnessing distinct musical styles to address particular topics. In particular, 
he notes that the genres he designates ``jazz/bohemian'' rap and ``reality'' rap articulated themselves
...
a commercial mainstream.\footnote{
    \autocite[64--65]{adamkrimsRapMusicPoetics2000}. Krims offers two distinct case studies---The Roots'
    ``What They Do'' and RZA's introduction on Wu-Tang Clan's \textit{Wu-Tang Forever} (1997)---as instances
    of each genre directly addressing what it conceived to be the commercial mainstream at the time.}
...
Notably, however, the sonic profile of ``Unapologetic'' does not fit neatly into the generic category Krims
constructs. While he allows for a music-stylistic eclecticism in bohemian rap, artists such as A Tribe 
Called Quest, De La Soul, Jungle Brothers, and The Roots all rely to \emph{some} degree on the sound of 
jazz in their music.\footnote{\autocite[65--66]{adamkrimsRapMusicPoetics2000}.} Without the samples to
signify some relationship to jazz in sound, ``Unapologetic'' cannot reach listeners as ``bohemian''---
at least not in the same way that groups like Tribe did in the 90s. Aside from its lyrically bohemian
approach, the, how might ``Unapologetic'' fit within a stylistic-historic context?
